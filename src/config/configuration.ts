...
export interface Configuration {
  ...
  /**
   * AWS S3 (or LocalStack) configuration used by RecordingStorageService.
  ...
  /**
   * Recording-worker configuration.
   */
  recording: {
    /**
  ...
  call: {
     ...
     * engine.  Each field drives one leg of the state machine:
     *
  ...
  /**
   * Write-behind reconciliation flush.
