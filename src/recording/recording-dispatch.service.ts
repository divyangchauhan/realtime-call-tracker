 ...
 * whenever a call reaches the COMPLETED state.  The @Processor worker in the
 * recording worker process consumes these jobs, uploads the recording to S3,
 * and writes the resulting URL back to Postgres and Redis.
 *
 * Idempotency note:
